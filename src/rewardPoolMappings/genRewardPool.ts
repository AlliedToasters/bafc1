...
import {
    ...
    RewardPaid,
    Withdraw
  } from "../../generated/genRewardPool/genRewardPool"
...
poolMappings.set("0", "ape")
poolMappings.set("1", "ape-vape")
poolMappings.set("2", "weth")
poolMappings.set("3", "dai")
poolMappings.set("4", "usdc")
poolMappings.set("5", "frax")
poolMappings.set("6", "wxBTRFLY")
poolMappings.set("7", "gOHM")
poolMappings.set("8", "STG")
poolMappings.set("9", "banana")
poolMappings.set("10", "pixl")
poolMappings.set("11", "premia")
poolMappings.set("12", "JPEG")
poolMappings.set("13", "bubble")
poolMappings.set("14", "milady")
...
export function handleWithdraw(event: Withdraw): void {
    ...
    withdraw.rewardContract = "genesis"
