...
import {
    ...
    RewardPaid,
    Withdraw
  } from "../../generated/boardApeRewardPool/boardApeRewardPool"
...
poolMappings.set("1", "vape-bape")
poolMappings.set("2", "vape-weth")
poolMappings.set("3", "bape-weth")
poolMappings.set("4", "vape")
...
export function handleDeposit(event: Deposit): void {
    ...
    stake.poolContract = "bapeRewards"
...
export function handleRewardPaid(event: RewardPaid): void {
    ...
    reward.poolId = "NA"
    reward.rewardContract = "bapeRewards"
    ...
    let holder = getHolder(event.params.user.toHex())
    holder.bapeRewarded = holder.bapeRewarded.plus(event.params.amount)
    holder.save()
...
export function handleWithdraw(event: Withdraw): void {
    ...
    withdraw.rewardContract = "bapeRewards"
