...
import {
    ...
    RewardPaid,
    Withdraw
  } from "../../generated/apeRewardPool/apeRewardPool"
...
poolMappings.set("1", "vape-weth")
poolMappings.set("2", "vape")
...
export function handleDeposit(event: Deposit): void {
    ...
    stake.poolContract = "vapeRewards"
...
export function handleRewardPaid(event: RewardPaid): void {
    ...
    reward.poolId = "NA"
    reward.rewardContract = "vapeRewards"
...
export function handleWithdraw(event: Withdraw): void {
    ...
    withdraw.rewardContract = "vapeRewards"
