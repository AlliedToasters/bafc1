...
import {
  ...
  Transfer
} from "../../generated/vapeApeLP/vapeApeLP"
...
export function handleTransfer(event: Transfer): void {
  ...
  recipient.vapeApeBalance = recipient.vapeApeBalance.plus(event.params.value)
  sender.vapeApeBalance = sender.vapeApeBalance.minus(event.params.value)
  sender.save()
  recipient.save()

  saveTran(event, "vape-ape")
  trackGas(event)
}
