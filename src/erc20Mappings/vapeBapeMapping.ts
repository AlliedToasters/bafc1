...
import {
  ...
  Transfer
} from "../../generated/vapeBapeLP/vapeBapeLP"
...
export function handleTransfer(event: Transfer): void {
  ...
  recipient.bapeVapeBalance = recipient.bapeVapeBalance.plus(event.params.value)
  sender.bapeVapeBalance = sender.bapeVapeBalance.minus(event.params.value)
  sender.save()
  recipient.save()
  saveTran(event, "vape-bape")
  trackGas(event)
}
