...
export function handleTransfer(event: Transfer): void {
  ...
  recipient.yugapeBalance = recipient.yugapeBalance.plus(event.params.value)
  sender.yugapeBalance = sender.yugapeBalance.minus(event.params.value)
  sender.save()
  recipient.save()

  saveTran(event, "yugape")
  trackGas(event)
}
